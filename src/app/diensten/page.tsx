    ...
    <>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <h1 className="text-3xl sm:text-4xl font-bold">Onze diensten</h1>
            ...
            >
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-start ${index % 2 === 1 ? 'lg:direction-rtl' : ''}`}>
                ...
                <div>
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center bg-blue-800 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-blue-900 transition-colors"
                  >
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8">
                  <div className="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center text-blue-800 mb-5">
