    ...
    return (
      <div className="text-center py-8 text-slate-500">
        ...
        <a
          ...
          className="text-brand-800 hover:underline mt-2 inline-block"
        >
    ...
    >
      ...
      <div className="p-5">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-8 h-8 bg-brand-800 rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <span className="inline-block mt-3 text-xs font-medium text-brand-800 group-hover:underline">
          Bekijk op Facebook →
        </span>
      </div>
    </a>
